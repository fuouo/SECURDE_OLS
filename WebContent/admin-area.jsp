      ...
      <div class="visibility-warn"><i class="flaticon-safebox"></i>Visible to Library Officers only</div>
        ...
        <div id = "manage-books" class ="content lesser-padding-content">
          ...
          <div id="content-add-book" class="lesser-padding-content toggable" >
            ...
            <div class="content">
              <div class="form-group">
                <select id="rm-type" class="form-control form-components-rd">
              ...
              <input type="text" class="form-control form-components-rd" id="location-id" placeholder="Location" style="width:70%" required>

              <label for="author-name">Author/s <i>(If more then 2 authors, please separated with & (ampersand) )</i></label>
              <input type="text" class="form-control form-components-rd" id="author-name" placeholder="Author/s" style="width:70%" required>

              <label for="author-name">Publisher</label>
              <input type="text" class="form-control form-components-rd" id="publisher" placeholder="Publisher" style="width:70%" required>

              <label for="year-published">Year Published</label>
              <input type="number" class="form-control form-components-rd" id="year-published" placeholder="Year Published" style="width:70%" required>

              <label for="year-published">Tags</label>
              <input type="text" class="form-control form-components-rd" id="year-published" placeholder="Year Published" style="width:70%" required>
              <br>
          ...
          <div class="rm-results">
            ...
            <div class="row rm-gen-details">
              ...
              <div class="col-md-10 rm-information">
                ...
                <div class="row">
                  <b>
                  <div class="col-md-2"><u>Location</u></div>
                  <div class="col-md-2"><u>Status</u></div>
                  <div class="col-md-2"><u>Reserver</u></div>
                  <div class="col-md-2"><u>Borrower</u></div></b>
                  <div class="col-md-2"></div></b>
                  <div class="col-md-2"></div></b>
                </div>
                <div class="location-status">
                  <div class="row">
                    <div class="col-md-2"><span class="location">Location</span></div>
                    <div class="col-md-2"><span class="available-status">AVAILABLE</span></div>
                    <div class="col-md-2"><span class="reserved-by">--</span></div>
                    <div class="col-md-2"><span class="borrowed-by">--</span></div>
                    <div class="col-md-2"><button class="reserve-inline btn btn-default override-btn disabled">Override<br> Reservation</button></div>
                    <div class="col-md-1"><button class="reserve-inline btn btn-default delete-btn"><i class="flaticon-trash"></i></button></div>
                  </div>
                </div>
            ...
            <div class="row rm-gen-details">
              ...
              <div class="col-md-10 rm-information">
                ...
                <div class="location-status">
                  <div class="row">
                    <div class="col-md-2"><span class="location">Location</span></div>
                    <div class="col-md-2"><span class="borrowed-status">BORROWED</span></div>
                    <div class="col-md-2"><span class="reserved-by">--</span></div>
                    <div class="col-md-2"><span class="borrowed-by">ID#</span></div>
                    <div class="col-md-2"><button class="reserve-inline btn btn-default override-btn disabled">Override<br> Reservation</button></div>
                    <div class="col-md-1"><button class="reserve-inline btn btn-default delete-btn disabled"><i class="flaticon-trash"></i></button></div>
                  </div>
                </div>
            ...
            <div class="row rm-gen-details">
              ...
              <div class="col-md-10 rm-information">
                ...
                <div class="location-status">
                  <div class="row">
                    <div class="col-md-2"><span class="location">Location</span></div>
                    <div class="col-md-2"><span class="reserved-status">RESERVED</span></div>
                    <div class="col-md-2"><span class="reserved-by">ID#</span></div>
                    <div class="col-md-2"><span class="borrowed-by">ID#</span></div>
                    <div class="col-md-2"><button class="reserve-inline btn btn-default override-btn">Override<br> Reservation</button></div>
                    <div class="col-md-1"><button class="reserve-inline btn btn-default delete-btn disabled"><i class="flaticon-trash"></i></button></div>
                  </div>
                </div>
              </div>
...
<form id="addNewRM" action="AddRMServlet" method="post"></form>
